...
description: Help 提示词南郭 prepare provider-safe prompts and handoff data for Suno/KIE generation and post-analysis tools.
---

# Suno Prompt Tool Handoff

- Compile one concise provider-ready prompt from structured lyrics, melody, and arrangement fields.
- Keep provider details out of 提示词南郭 responsibilities: actual generation is handled by `providers.kie_suno.KieSunoProvider`.
